        ...
        <Row className="justify-content-center">
          <div className="appli-details">
            ...
            <div className="text-appli">
              <p> Création : {this.getDate(appliInfosMarket.Stack.CreatedAt)}</p>
              <p>Dernière mise à jour : {this.getDate(appliInfosMarket.Stack.UpdatedAt)}</p>
            </div>
            ...
            {this.state.modify === "error" && (
              <Alert className="install" variant="danger">
                Erreur lors de la modification, réessayer plus tard.
              </Alert>
            )}
          </div>
        </Row>
